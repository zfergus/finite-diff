...
if(TARGET finitediff::warnings)
    return()
endif()

set(FINITE_DIFF_FLAGS
    -Wall
    -Wextra
    -pedantic
...
add_library(finitediff_warnings INTERFACE)
add_library(finitediff::warnings ALIAS finitediff_warnings)

foreach(FLAG IN ITEMS ${FINITE_DIFF_FLAGS})
    ...
    if(IS_SUPPORTED_${FLAG_VAR})
        target_compile_options(finitediff_warnings INTERFACE ${FLAG})
    endif()
endforeach()
